...
depends 'ark', '0.8.2'              # https://github.com/opscode-cookbooks/ark
...
depends 'mysql', '5.2.10'           # https://github.com/opscode-cookbooks/mysql
depends 'database', '2.2.0'         # https://github.com/opscode-cookbooks/database
depends 'nginx', '2.7.0'            # https://github.com/opscode-cookbooks/nginx
depends 'php', '1.4.6'              # https://github.com/opscode-cookbooks/php
depends 'php-fpm', '0.6.7'          # https://github.com/yevgenko/cookbook-php-fpm
depends 'composer', '1.0.1'         # https://github.com/escapestudios/chef-composer
